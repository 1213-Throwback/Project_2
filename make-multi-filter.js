...
let currentArray = arrayFilterer1();
...
let arrayFilterer2 = MakeMultiFilter([1, 2, 3]);
let currentArray2 = arrayFilterer2(filterTwos)(filterThrees)();
console.log('currentArray2', currentArray2); // prints [1] since we filtered out 2 and 3

// Multiple active filters at the same time
let arrayFilterer3 = MakeMultiFilter([1, 2, 3]);
let arrayFilterer4 = MakeMultiFilter([4, 5, 6]);
